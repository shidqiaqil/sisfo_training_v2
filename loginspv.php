...
<body>
    ...
    <div class="container-fluid h-custom">
        ...
        <div class="col-md-9 col-lg-6 col-xl-5">
            <img src="assets\img\5236.jpg"
            class="img-fluid" alt="Sample image">
        </div>
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form method="post" action="cek_login_spv.php">
            <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                
                <p class="lead fw-normal mb-0 me-3 fw-bold">Our Social Media</p>
                <button style="background-color: #82b479; border-color: #82b479;" type="button" class="btn btn-primary btn-floating mx-1">
            ...
            <div class="divider d-flex align-items-center my-4">
                <p class="text-center fw-bold mx-3 mb-0">Sign in Supervisor</p>
            </div>
            ...
            <div class="form-outline mb-4">
                ...
                name="id_spv" placeholder="Masukkan Id Karyawan" />
            ...
            <div class="form-outline mb-3">
                ...
                type="password" name="password_spv" placeholder="Masukkan password"/>
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
                ...
                style="padding-left: 2.5rem; padding-right: 2.5rem; background-color: #82b479; border-color: #82b479;" type="submit" ">Login</button>
                <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="#!"
                    class="link-danger" style="color:#82b479;">Please Ask HR to Register Account</a></p>
            </div>
    ...
    <div style="background-color: #82b479;"
