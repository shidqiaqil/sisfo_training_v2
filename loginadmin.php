...
<body>
    ...
    <div class="container-fluid h-custom">
        ...
        <div class="col-md-9 col-lg-6 col-xl-5">
            <img src="assets\img\730_generated.jpg"
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
                ...
                <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="#!"
                    class="link-danger">Please Ask HR to Register Account</a></p>
            </div>
    ...
    <div
        class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 btn-primary">
        <!-- Copyright -->
        ...
        <!-- Right -->
        <div>
        <a href="https://www.vecteezy.com/free-vector/login" style="color: white; font-size: 10px;">Login Vectors by Vecteezy</a>
